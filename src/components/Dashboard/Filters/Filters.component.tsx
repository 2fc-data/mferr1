...
export const Filters: React.FC<FilterProps> = ({
  ...
  return (
    <div className="flex gap-6 mb-4 mt-1 px-4 py-2 items-center flex-wrap rounded-lg bg-card text-card-foreground border border-border shadow-card">
      ...
      {periodType !== "ano" && (
        <div className="flex flex-col">
          ...
          <select
            ...
            className="h-9 px-3 rounded-lg border border-input bg-background text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
            value={periodValue}
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          className="h-9 px-3 py-1 rounded-lg border border-input bg-background text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
